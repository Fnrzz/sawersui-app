export const CONFIG = {
  SUI: {
    NETWORK: (process.env.NEXT_PUBLIC_SUI_NETWORK as 'mainnet' | 'testnet') || 'testnet',
    RPC_URL: process.env.NEXT_PUBLIC_SUI_NETWORK === 'mainnet'
    ...
    ADDRESS: {
      ...
      DONATION_EVENT_TYPE: process.env.NEXT_PUBLIC_DONATION_EVENT_TYPE || "",
    }
  },
  SUPABASE: {
...
if (typeof window === 'undefined') { // Server-side check
   ...
   if (!CONFIG.SUI.ADDRESS.USDC_TYPE) console.warn("Missing NEXT_PUBLIC_ADDRESS_USDC");
}
